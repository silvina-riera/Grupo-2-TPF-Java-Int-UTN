...
public class Prueba {
        ...
        Cliente cliente = ObjetosUtilitarios1.cliente();
        ...
        // Se crea el operador
        Operador operador = ObjetosUtilitarios1.operador();
        OperadorService opServ = new OperadorService();
        opServ.crearOperador(operador);
        
        // Se crea la especialidad
        Especialidad esp = ObjetosUtilitarios1.Especialidad1();
        ...
        TipoProblema problema1 = ObjetosUtilitarios1.problema1();
        ProblemaService ps = new ProblemaService();
        problema1.setEspecialidad(esp);
        ps.crearProblema(problema1);
        
        TipoProblema problema2 = ObjetosUtilitarios1.problema2();
        problema2.setEspecialidad(esp);
        ps.crearProblema(problema2);
        
        // Se crea el técnico
        Tecnico tecnico = ObjetosUtilitarios1.tecnico1();
        ...
        Incidente incidente = ObjetosUtilitarios1.incidente1();
